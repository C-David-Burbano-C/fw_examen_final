"""Base settings for seguimiento_proyectos_carlos_luciana_alejandro."""

from pathlib import Path

BASE_DIR = Path(__file__).resolve().parent.parent

SECRET_KEY = 'django-insecure-ni^h+4htv$^*ybd8)l5_!canuf!eiow1e4()jww4ck=^6w+-6^'
...
LOGIN_URL = 'login'
LOGIN_REDIRECT_URL = 'gestion_proyectos:dashboard'
